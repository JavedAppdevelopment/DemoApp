...
namespace DemoApp.iOS
{
	...
	public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate
	{
		...
		{
			var logger = (DemoApp.Common.Logging.ILogger)ContainerManager.Container.Resolve(typeof(DemoApp.Common.Logging.ILogger), typeof(DemoApp.Common.Logging.ILogger).GetType().ToString());
